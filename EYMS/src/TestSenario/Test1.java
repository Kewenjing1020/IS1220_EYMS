...
public class Test1 {
	...
	public static void main(String [] args) {
		...
		Client c1=new Client("username1", "password1", "first_name1", "last_name1",true, "06/01",new BasicFidelityCard());
		Client c2=new Client("username2", "password2", "first_name2", "last_name2",true, "07/02",new BasicFidelityCard());
		Client c3=new Client("username3", "password3", "first_name3", "last_name3",false, "07/03",new BasicFidelityCard());
		Client c4=new Client("username4", "password4", "first_name4", "last_name4",false, "08/04",new PointFidelityCard());
		...
		Meal e1=new Meal("mealName1", "ingredient_detail1", 5.5);
		e1.setSpecial_price((double) 4);
		e1.setStock(10);
		
		Meal e2=new Meal("mealName2", "ingredient_detail2", 7.2);
